function main() {
    ...
    function loadDueDate(uid) {
        db.collection("users").doc(uid).collection("sports").doc("dueDate").onSnapshot((doc) => {
            let dueDate;
            if (doc.exists) {
    ...
    function loadItems(uid) {
        db.collection("users").doc(uid).collection("sports").doc("items").onSnapshot((doc) => {
            ...
            if (doc.exists) {
                ...
                console.log("Sports items loaded from Firestore (real-time update).");
            } else {
