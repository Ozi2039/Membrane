...
function main() {
    ...
    let unsubscribe = null; // To hold the listener unsubscribe function
    ...
    function renderList(data) {
        if (data && data.quickTaps) {
            list.innerHTML = "";
            data.quickTaps.forEach(item => addItem(item.title, item.description, item.order));
            sortList();
        } else {
            list.innerHTML = ""; // Clear list if no data
        }
    }
    ...
    async function saveList() {
        ...
        await saveData(currentUser.uid, { quickTaps: items });
    }
}
